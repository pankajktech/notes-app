...
export const NoteDeleted = () => {
  return (
    <div className="alert alert-error shadow-lg w-72 z-20 absolute right-20 md:right-10 top-10">
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="stroke-current flex-shrink-0 h-6 w-6"
...
export const NoteEdited = () => {
  return (
    <div className="alert alert-warning shadow-lg w-72 z-20 absolute right-20 md:right-10 top-10">
      <div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="stroke-current flex-shrink-0 h-6 w-6"
